            ...
            raw_response = json.dumps(
                {
                    ...
                    "command_pass": _strip_code_fences(command_result.get("raw_response", "")),
                    "selection_pass_stripped": _strip_code_fences(selection_result.get("raw_response", "")),
                    "command_pass_stripped": _strip_code_fences(command_result.get("raw_response", "")),
                }
            )
